...
public class TestAuto extends TemplateAuto {
    ...
    public TestAuto() {
        ...
        trajectory = TrajectoryGenerator.generateTrajectory(new Pose2d(new Translation2d(), new Rotation2d(180)), pointList,
                new Pose2d(-5, 2.5, new Rotation2d(90)), trajectoryConfig);
