...
public final class Climber extends AbstractSubsystem {
    ...
    public void logData() {
        ...
        if (stepByStep) {
            logData("Current Climber WaitCondition", climbStatePair.stepbystep.waitCondition.apply(this), true);
        } else {
            logData("Current Climber WaitCondition", climbStatePair.automatic.waitCondition.apply(this), true);
        }
    }
